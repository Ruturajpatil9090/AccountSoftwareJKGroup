...
import { TextField, Grid, Checkbox, Box, Container, FormControlLabel } from "@mui/material";
...
const UTREntry = () => {
  ...
  const fetchLastRecord = () => {
    fetch(`${API_URL}/get-lastutrdata?Company_Code=${companyCode}&Year_Code=${Year_Code}`)
      .then((response) => {
        if (!response.ok) {
          ...
          <div className="form-group ">
            <div>
              <Grid container spacing={2} >
                ...
                <Grid item xs={12} sm={6} md={2} ml={2}>
                  <TextField
                    label="Entry No"
                    name="doc_no"
                    variant="outlined"
