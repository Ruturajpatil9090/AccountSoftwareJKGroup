...
import {
  TextField, Select, MenuItem, Grid, InputLabel, FormControl, OutlinedInput, Box, Table, TableHead, TableRow, TableCell, TableBody, Button, FormControlLabel,
} from "@mui/material";
...
const DeliveryOrder = () => {
  ...
  const handleDocDateChange = async (event) => {
    const { name, value } = event.target;
  ...
  const handleKeyDownCalculations = async (event) => {
    ...
    if (event.key === "Tab") {
      ...
      setUsers((prevUsers) =>
        prevUsers.map((user) =>
          user.id === 1
            ? { ...user, Amount: updatedFormData.amount } 
            : user
        )
      );
  ...
  const handleSaveOrUpdate = async () => {
    const millamount = formData.amount;
    const bankamt = formDataDetail.Amount;
  ...
  //Delivery Order Detail section State Management
    ...
    <>
      ...
      <div>
        <form>
          ...
          <Grid container spacing={2} mt={1} alignItems="center" direction="row">
            <Grid item xs={2}>
              <TextField
                fullWidth
                label="Doc No"
            ...
            <Grid item xs={1}>
              <TextField
                fullWidth
                label="Carporate Sale Year Code"
                variant="outlined"
          ...
          <Box sx={{ padding: 2 }} ml={12}>
            <Grid container spacing={1} alignItems="center">
              {/* Grade */}
              <Grid item xs={1}>
                <FormControl fullWidth variant="outlined">
                  <InputLabel htmlFor="grade" shrink style={{ fontSize: '22px', fontWeight: 'bold' }}>Grade</InputLabel>
                  <OutlinedInput
                    id="grade"
                    name="grade"
                    autoComplete="off"
              ...
              <Grid item xs={1}>
                <FormControl fullWidth variant="outlined" size="small">
                  <InputLabel htmlFor="quantal" shrink style={{ fontSize: '22px', fontWeight: 'bold' }}>
                    Quantal
                  </InputLabel>
                  <OutlinedInput
                    id="quantal"
              ...
              <Grid item xs={1}>
                <FormControl fullWidth variant="outlined">
                  <InputLabel htmlFor="packing" style={{ fontSize: '22px', fontWeight: 'bold' }}>Packing</InputLabel>
                  <OutlinedInput
                    id="packing"
                    name="packing"
              ...
              <Grid item xs={1}>
                <FormControl fullWidth variant="outlined">
                  <InputLabel htmlFor="bags" shrink style={{ fontSize: '22px', fontWeight: 'bold' }}>Bags</InputLabel>
                  <OutlinedInput
                    id="bags"
                    name="bags"
              ...
              <Grid item xs={1}>
                <FormControl fullWidth variant="outlined">
                  <InputLabel htmlFor="excise_rate" shrink style={{ fontSize: '22px', fontWeight: 'bold' }}>Excise Rate</InputLabel>
                  <OutlinedInput
                    id="excise_rate"
                    name="excise_rate"
              ...
              <Grid item xs={2}>
                <FormControl fullWidth variant="outlined">
                  <InputLabel htmlFor="final_amout" style={{ fontSize: '22px', fontWeight: 'bold' }}>Mill Amount</InputLabel>
                  <OutlinedInput
                    id="final_amout"
                    name="final_amout"
          ...
          <Grid container spacing={2} mt={1} ml={12}>
            <Grid item xs={1}>
              <TextField
                label="Commision"
          ...
          <Grid container spacing={2} mt={1} ml={12} alignItems="center">
            <Grid item xs={1}>
              <TextField
                label="Truck No"
                id="truck_no"
            ...
            <label htmlFor="transport" style={{ marginLeft: "20px" }}>Transport</label>
            <AccountMasterHelp
            ...
            <label htmlFor="TransportGSTStateCode" style={{ marginLeft: "20px" }}>TransportGSTStateCode : </label>
            <GSTStateMasterHelp
          ...
          <div>
            <Grid container spacing={2} ml={6} mt={1}>
        ...
        <Table className="mt-4" bordered>
          <TableHead>
            <TableRow>
              ...
              <TableCell>dodetailid</TableCell>
              <TableCell>Rowaction</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {users.map((user) => (
              <TableRow key={user.id}>
                ...
                <TableCell>{user.ddType}</TableCell>
                <TableCell>{user.Bank_Code || tenderDetails.Payment_To}</TableCell>
                <TableCell>
                  {user.bankcodeacname ||
                ...
                <TableCell>{user.UTR_NO}</TableCell>
                <TableCell>{user.LTNo}</TableCell>
                <TableCell>{user.bc || tenderDetails.pt}</TableCell>
                <TableCell>{user.dodetailid}</TableCell>
