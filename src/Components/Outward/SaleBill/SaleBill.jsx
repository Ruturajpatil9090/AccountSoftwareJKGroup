...
import { TextField, Grid, InputLabel, FormControl, Select, MenuItem, FormControlLabel, Checkbox, TextareaAutosize, Button, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Typography } from '@mui/material';
...
const SaleBill = () => {
  ...
  return (
    <>
      ...
      />
      <Typography variant="h6" style={{ textAlign: 'center', fontSize: "24px", fontWeight: "bold" }}>Sugar Sale Bill</Typography>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="">
          ...
          <div >
            ...
            <TableContainer component={Paper} className="mt-4" sx={{ width: "75%" }} >
          ...
          <div style={{ flex: 1, paddingRight: '30px', }}>
            <div className="SaleBill-row" >
              <Grid container spacing={2}>
                ...
                <Grid container spacing={1} justifyContent="flex-end" alignItems="center" style={{ float: "right" }}>
                  <Grid item xs={1}>
