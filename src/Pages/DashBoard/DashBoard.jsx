...
import { FaUserPlus, FaTruck, FaMoneyBillWave, FaFileInvoice, FaDatabase, FaShoppingBag, FaReceipt, FaBalanceScale, FaBoxOpen, FaClipboardCheck, FaTruckMoving, FaBook, FaChartBar, FaFileAlt, FaCalendarAlt, FaUsers, FaHandshake, FaFileExcel } from 'react-icons/fa';
  ...
  return (
    <>
      ...
      <div className="CommonbuttonContainer">
        ...
        <DashboardButton label="Transport SMS" icon={FaTruckMoving} path="/transport-sms" />
        <DashboardButton label="Stock Book" icon={FaBook} path="/stock-book" />
        <DashboardButton label="Stock Summary" icon={FaChartBar} path="/stock-summary" />
